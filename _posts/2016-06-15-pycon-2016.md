...
This creaates a dot that wanders around the 5x5 matrix and bumps into
walls an corners. We didn't submit it because it seemed too simple compared
...
very happy working with Canonical. We figured out that we had both worked
on the Gnu Emacs C++ mode. I created the mode way back when I was working at
the University of Washington School of Oceanography with Tom Keffer (who later
used our work to start Rogue Wave, supplier of C++ libraries). However, I didn't
do very much with it; just got the basic mode working. Sometime later Barry
came along and spent a lot of time making it useful, especially the very
